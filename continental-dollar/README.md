...
| `data/published/bezanson_1951_appendix1_monthly_prices.csv` | Average monthly wholesale prices, 25 commodities, Philadelphia 1770–1790 (521 of 525 possible commodity-year series; the 4 missing (Tobacco, 1773-1776) are confirmed gaps in the source, see the file header) |
